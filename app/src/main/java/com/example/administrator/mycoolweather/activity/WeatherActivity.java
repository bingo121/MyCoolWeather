...
import com.example.administrator.mycoolweather.MyApplication;
import com.example.administrator.mycoolweather.R;
import com.example.administrator.mycoolweather.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    /**
     * 从服务器查询天气代号为weatherId的地区的天气信息，将其保留在本地并在界面上显示出来
     * @param weatherId
     */
    public void requestWeather(final String weatherId){
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = Utility.handleWeatherReseponse(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
